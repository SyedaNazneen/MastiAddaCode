...
SECRET_KEY = 'django-insecure--t26$lee765wf=ba96&bofao87xdij-jftm9_wd8xd=z6lid8q'
...
ROOT_URLCONF = 'MastiAddaProject.urls'
...
WSGI_APPLICATION = 'MastiAddaProject.wsgi.application'
...
# MastiAddaProject/settings.py (File ke aakhir mein)
